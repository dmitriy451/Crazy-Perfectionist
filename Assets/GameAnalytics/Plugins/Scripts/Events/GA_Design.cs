...
namespace GameAnalyticsSDK.Events
{
    public static class GA_Design
    {
        ...
        ///     Identifies the event so this should be as descriptive as possible. PickedUpAmmo might be a good event name.
        ///     EventTwo is a bad event name! <see cref="System.String" />
        /// </param>
        /// <param name="eventValue">
        ///     A value relevant to the event. F.x. if the player picks up some shotgun ammo the eventName could be "PickedUpAmmo"
        ///     and this value could be "Shotgun". This can be null <see cref="System.Nullable<System.Single>"/>
        /// </param>
