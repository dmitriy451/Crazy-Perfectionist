...
# endif
        ...
        ///     Custom fields to add to the event. Dictionary of key-value pairs. Only string or numbers
        ///     allowed as values. Custom fields are only stored in raw events and can only be used for data export (i.e. not
        ///     visible in the tool).
        /// </param>
        public static void NewBusinessEvent(string currency, int amount, string itemType, string itemId,
 ...
 = false)
        ...
        /// </param>
        public static void NewBusinessEventGooglePlay(string currency, int amount, string itemType, string itemId,
            string cartType, string receipt, string signature, IDictionary<string, object> customFields,
        ...
        /// <summary>
        ///     Track any type of design event that you want to measure i.e. GUI elements or tutorial steps. Custom dimensions are
        ///     not supported.
        /// </summary>
        /// <param name="eventName">
        ///     String can consist of 1 to 5 segments. Segments are seperated by ':' and segments can have a
        ///     max length of 16. (e.g. segment1:anotherSegment:gold).
        /// </param>
        ...
        /// <summary>
        ///     Measure player progression in the game. It follows a 3 hierarchy structure (world, level and phase) to indicate a
        ///     player's path or place.
        /// </summary>
        ...
        /// <summary>
        ///     Analyze your in-game economy (virtual currencies). You will be able to see the flow (sink/source) for each virtual
        ///     currency.
        /// </summary>
        ...
        ///     One of the available dimension values set in Settings (Setup tab). Will persist cross
        ///     session. Set to null to remove again.
        /// </param>
        ...
        /// </summary>
        /// <param name="customFields">
        ///     Set of key-value pairs to be used as global custom event fields to be added to all events.
        ///     Custom fields are only stored in raw events and can only be used for data export (i.e. not visible in the tool).
        /// </param>
        ...
        private static string GetUnityVersion()
        {
            ...
            for (var i = 0; i < splitUnityVersion.Length; i++)
            {
                ...
                {
                    var regexVersion = Regex.Split(splitUnityVersion[i], "[^\\d]+");
        ...
        public static void HierarchyWindowCallback(int instanceID, Rect selectionRect)
        {
            ...
            if (go != null && go.GetComponent<GameAnalytics>() != null)
            {
                ...
                if (SettingsGA.Logo == null)
                    SettingsGA.Logo =
                        (Texture2D)AssetDatabase.LoadAssetAtPath(WhereIs("gaLogo.png", "Texture2D"), typeof(Texture2D));
