...
public class ParentManipulator
{
    ...
    private static void NewMenuOption()
    {
        ...
        {
            var selected = s;
            var tr = ((GameObject)selected).GetComponent<Transform>();
            Debug.Log(selected);
    ...
    {
        var empty = GameObject.CreatePrimitive(PrimitiveType.Cube);
        Object.DestroyImmediate(empty.GetComponent<MeshRenderer>());
        Object.DestroyImmediate(empty.GetComponent<MeshFilter>());
        Object.DestroyImmediate(empty.GetComponent<BoxCollider>());
