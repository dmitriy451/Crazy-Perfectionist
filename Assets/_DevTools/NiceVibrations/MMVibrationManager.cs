...
namespace MoreMountains.NiceVibrations
{
    ...
    public static class MMVibrationManager
    {
        ...
        private static readonly long[] _successPattern = { 0, LightDuration, LightDuration, HeavyDuration };
        private static readonly int[] _successPatternAmplitude = { 0, LightAmplitude, 0, HeavyAmplitude };
        private static readonly long[] _warningPattern = { 0, HeavyDuration, LightDuration, MediumDuration };
        private static readonly int[] _warningPatternAmplitude = { 0, HeavyAmplitude, 0, MediumAmplitude };
        ...
        public static void Vibrate()
        {
            if (DataManager.Instance.settingsData.IsVibrationOn)
            {
                ...
                else if (iOS()) iOSTriggerHaptics(HapticTypes.MediumImpact);
            }
        }
        ...
        public static void Haptic(HapticTypes type)
        {
            if (DataManager.Instance.settingsData.IsVibrationOn)
            {
                ...
                else if (iOS()) iOSTriggerHaptics(type);
            }
        }
 ...
 CurrentActivity.Call<AndroidJavaObject>("getSystemService", "vibrator");
        ...
        /// <summary>
        ///     Requests a vibration of the specified amplitude and duration. If amplitude is not supported by the device's SDK, a
        ///     default vibration will be requested
        /// </summary>
        /// <param name="milliseconds">Milliseconds.</param>
        ...
        public static void AndroidVibrate(long[] pattern, int repeat)
        {
            ...
            {
                VibrationEffectClassInitialization();
                VibrationEffect = VibrationEffectClass.CallStatic<AndroidJavaObject>("createWaveform", pattern, repeat);
                AndroidVibrator.Call("vibrate", VibrationEffect);
            }
        }
        ...
        public static void AndroidVibrate(long[] pattern, int[] amplitudes, int repeat)
        {
            ...
            else
            {
                VibrationEffectClassInitialization();
                VibrationEffect =
                    VibrationEffectClass.CallStatic<AndroidJavaObject>("createWaveform", pattern, amplitudes, repeat);
                AndroidVibrator.Call("vibrate", VibrationEffect);
            }
        }
        ...
        /// <summary>
        ///     Call this method to initialize the haptics. If you forget to do it, Nice Vibrations will do it for you the first
        ///     time you
        ...
        /// <summary>
        ///     Releases the feedback generators, usually you'll want to call this at OnDisable(); or anytime you know you won't
        ///     need
        ///     vibrations anymore.
        /// </summary>
        ...
        /// <summary>
        ///     This methods tests the current device generation against a list of devices that don't support haptics, and returns
        ///     true if haptics are supported, false otherwise.
        /// </summary>
