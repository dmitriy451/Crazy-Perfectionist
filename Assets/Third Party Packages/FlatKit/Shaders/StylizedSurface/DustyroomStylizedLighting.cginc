...
inline half4 LightingDustyroomStylized_Deferred(
    SurfaceOutputDustyroom s, float3 viewDir, UnityGI gi, out half4 outGBuffer0, out half4 outGBuffer1,
    out half4 outGBuffer2)
{
    ...
    half4 c = UNITY_BRDF_PBS(s.Albedo, specColor, oneMinusReflectivity, s.Smoothness, s.Normal, viewDir, gi.light,
                             gi.indirect);
    ...
    out half4 outGBuffer2)
{
    // energy conservation
    half oneMinusReflectivity;
    s.Albedo = EnergyConservationBetweenDiffuseAndSpecular(s.Albedo, /*s.Specular*/s.Albedo, /*out*/
                                                           oneMinusReflectivity);

    half4 c = UNITY_BRDF_PBS(s.Albedo, /*s.Specular*/s.Albedo, oneMinusReflectivity, s.Smoothness, s.Normal, viewDir,
