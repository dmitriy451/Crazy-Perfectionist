...
namespace FlatKit
{
    public class FlatKitOutline : ScriptableRendererFeature
    {
        ...
        private void InitMaterial()
        {
            ...
            if (_material == null) Debug.LogWarning("[FlatKit] Missing Outline Material");
        ...
        {
            private readonly ProfilingSampler _profilingSampler = new("Outline");
...
#endif
                if (_destination == RenderTargetHandle.CameraTarget) cmd.ReleaseTemporaryRT(_temporaryColorTexture.id);
            }
        }
    }
}